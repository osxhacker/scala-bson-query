...
import io.github.osxhacker.query.criteria.expression.{
	IgnoreCase,
	MultilineMatching
	}
 ...
 * [[io.github.osxhacker.query.criteria.untyped]] EDSL functionality and
 * serves both to verify fitness as well as an exemplar to how the
 * [[io.github.osxhacker.query.criteria.untyped]] functionality can be used.
 *
 * @author svickers
 *
 */
