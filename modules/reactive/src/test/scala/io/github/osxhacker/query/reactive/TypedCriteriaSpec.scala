package io.github.osxhacker.query.reactive

import io.github.osxhacker.query.criteria.expression.IgnoreCase
 ...
 * [[io.github.osxhacker.query.reactive.typed]] EDSL functionality and serves
 * both to verify fitness as well as an exemplar to how the
 * [[io.github.osxhacker.query.reactive.typed]] functionality can be used.
 */
