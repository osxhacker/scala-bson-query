...
import io.github.osxhacker.query.ProjectSpec
import io.github.osxhacker.query.criteria._


/**
 * The '''EvaluationSpec''' type defines the unit-tests which certify the
 * [[io.github.osxhacker.query.criteria.expression.Evaluation]] types for
