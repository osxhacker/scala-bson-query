package io.github.osxhacker.query.sorting.expression
 ...
 * creating [[io.github.osxhacker.query.sorting.SortField]]s from arbitrary
 * [[io.github.osxhacker.query.sorting.PartialSortField]]s.
 */
